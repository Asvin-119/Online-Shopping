                    ...
                    <div class="header-info header-info-right">
                        <ul>
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" id="drop1" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="{{ asset('assets/imgs/theme/user-1.jpg') }}"
                                        class="rounded-circle" width="35" height="35" alt="User Profile" />
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end p-3 shadow" style="width: 280px;">
                                    <!-- Header -->
                                    ...
                                    <div class="text-center">
                                        <a href="#">
                                            <img src="{{ asset('assets/imgs/theme/user-1.jpg') }}"
                                                class="rounded-circle mb-2" width="70" height="70" alt="User Avatar" />
                                        </a>
                                        <h5 class="fw-semibold mb-0">Mathew Anderson</h5>
                                        <p class="text-muted mb-0">Designer</p>
                                        <p class="text-muted small">
                                            <i class="fas fa-envelope me-1"></i> info@gmail.com
                                        </p>
                                    </div>
                                    <!-- Log Out Button -->
