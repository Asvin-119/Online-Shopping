                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/imgs/shop/category-thumb-1.jpg')}}" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">T-Shirt</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"> <img src="{{ asset('assets/imgs/shop/category-thumb-2.jpg')}}" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Bags</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/imgs/shop/category-thumb-3.jpg')}}" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Sandan</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/imgs/shop/category-thumb-4.jpg')}}" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Scarf Cap</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/imgs/shop/category-thumb-5.jpg')}}" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Shoes</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/imgs/shop/category-thumb-6.jpg')}}" alt=""></a>
                        </figure>
                        <h5><a href="shop-grid-right.html">Pillowcase</a></h5>
                    </div>
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/imgs/shop/category-thumb-7.jpg')}}" alt=""></a>
                        </figure>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0" style="background-image: url({{ asset('assets/imgs/banner/menu-banner-7.jpg')}});">
                        <div class="deal-top">
                ...
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated" style="background-image: url({{ asset('assets/imgs/banner/menu-banner-8.jpg')}});">
                        <div class="deal-top">
            ...
            <div class="row">
                <div class="col-lg-3 d-none d-lg-flex">
                    <div class="banner-img style-2 wow fadeIn animated">
                        <img src="{{ asset('assets/imgs/banner/banner-9.jpg')}}" alt="">
                        <div class="banner-text">
...
<i class="fi-rs-eye"></i></a>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="banner-img banner-1 wow fadeIn animated">
                                <img src="{{ asset('assets/imgs/banner/banner-5.jpg')}}" alt="">
                                <div class="banner-text">
                        ...
                        <div class="col-md-6">
                            <div class="banner-img mb-15 wow fadeIn animated">
                                <img src="{{ asset('assets/imgs/banner/banner-6.jpg')}}" alt="">
                                <div class="banner-text">
                                    <span>Big Offer</span>
                            ...
                            <div class="banner-img banner-2 wow fadeIn animated">
                                <img src="{{ asset('assets/imgs/banner/banner-7.jpg')}}" alt="">
                                <div class="banner-text">
                                    <span>Smart Offer</span>
    ...
    <section class="mb-50">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="banner-bg wow fadeIn animated" style="background-image: url({{ asset('assets/imgs/banner/banner-8.jpg') }})">
